    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <a href="{{ route('barang-admin.acreate') }}"><button class="btn btn-primary btn-round ml-auto" >
                    Create Data
                </button>
            </a>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" nowrap>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barang-admin.adestroy', $post->id) }}" method="Post">
                                    <a href="/barang-admin/{{ $post->uuid }}" class="btn btn-sm btn-warning">EDIT</a>
                                    @csrf
                                    @method('DELETE')
                ...
                {{-- <a href="{{ route('barangadmin.aexport') }}" class="btn btn-sm btn-dark" >
