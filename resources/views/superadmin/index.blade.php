@extends('Temp.app', ['title' => 'Halaman admin', 'page_heading' => 'Daftar admin'])
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1"><b><a href="">{{$user}} <small> Pengguna</small></a></b></h5>
                        <small class="text-muted">Report Pengguna</small>
                    </div>
                </div>
            </div>
        </div>
