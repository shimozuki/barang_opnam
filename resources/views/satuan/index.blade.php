@extends('Temp.app', ['title' => 'Halaman satuan', 'page_heading' => 'Daftar satuan'])
...
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('satuan.export') }}"><button class="btn btn-success btn-round ml-auto" >
                <i class="fa fa-plus"></i>
                Add Row
            </button>
        </a>
        <a href="{{ route('satuan.generatePDF') }}"><button class="btn btn-success btn-round ml-auto" >
            <i class="fa fa-plus"></i>
            Add Row
        </button>
    </a> --}}

        <a href="{{ route('satuan.create') }}"><button class="btn btn-primary btn-round ml-auto" >
                    ...
                    @forelse ($satuans as $no => $post)
                        ...
                        <td class="text-center" nowrap>
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('satuan.destroy', $post->id) }}" method="Post">
                                <a href="{{ route('satuan.edit', $post->id) }}" class="btn btn-sm btn-warning">EDIT</a>
                                @csrf
                                @method('DELETE')
