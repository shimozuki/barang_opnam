      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('barangkeluar.astore') }}" method="Post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('jml') is-invalid @enderror" id="jml" name="jml"  placeholder="masukkan jumlah">
                  <!-- error message untuk title -->
                  @error('jml')
