    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="/barang-masuk-admin/update/{{ $barang_masuk->id }}" method="Post" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <input value="{{$barang_masuk->jml}}" type="text" class="form-control @error('jml') is-invalid @enderror" id="jml" name="jml" value="{{ old('jml') }}" placeholder="Masukkan Judul Post">
