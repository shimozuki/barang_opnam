    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('barang_masuk.acreate') }}">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" nowrap>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangmasuk.adestroy', $post->id) }}" method="Post">
                                    <a href="/barang-masuk-admin/{{ $post->uuid }}" class="btn btn-sm btn-warning">EDIT</a>
                                    @csrf
                                    @method('DELETE')
                ...
                {{-- <a href="{{ route('barang.aexport') }}" class="btn btn-sm btn-dark" >
