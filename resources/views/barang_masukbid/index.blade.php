    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('barang_masuk.bcreate') }}">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="add-row" class="display table table-striped table-head-bg-info table-hover" >
                    ...
                    <tbody>
                        @forelse ($barang_masuk as $no => $post)
                        <tr>
                            ...
                            <td class="text-center" nowrap>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangmasuk.bdestroy', $post->id) }}" method="Post">
                                    <a href="/barang-masuk-bidang/{{ $post->uuid }}" class="btn btn-sm btn-warning">EDIT</a>
                                    @csrf
                                    @method('DELETE')
                ...
                {{-- <a href="{{ route('bidang.exportmsk') }}" class="btn btn-sm btn-dark" >
