...
footer {
  ...
  <body>
    ...
    <main>
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="service">{{ $post->barang->user->name }}</td>
                <td class="service">{{ $post->barang->name }}</td>
                <td class="service"> Rp.{{ number_format($post->barang->harga) }}</td>
                <td class="service">{{ $post->jml }}</td>
                <td class="service">{{ $post->tujuan }}</td>
      ...
      <div id="notices">
        <div>NOTICE:</div>
        <div class="notice">stock opname - invoice barang keluar</div>
      </div>
    </main>
    <footer>
      sistem pengelolahan data dan informasi BPPRD Kota Jambi
    </footer>
  </body>
</html>
