                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" nowrap>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangkeluar.destroy', $post->id) }}" method="Post">
                                    <a href="/barang-keluar/{{ $post->uuid }}" class="btn btn-sm btn-warning">EDIT</a>
                                    @csrf
                                    @method('DELETE')
