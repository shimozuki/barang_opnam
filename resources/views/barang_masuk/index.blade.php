                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" nowrap>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangmasuk.destroy', $post->id) }}" method="Post">
                                    <a href="/barang-masuk/{{ $post->uuid }}" class="btn btn-sm btn-warning">EDIT</a>
                                    @csrf
                                    @method('DELETE')
